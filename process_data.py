...
def build_data_cv(datafile, cv=10, clean_string=True):
    ...
    with codecs.open(datafile, "r", encoding='utf-8', errors='ignore') as csvf:
...
if __name__ == "__main__":
    w2v_file = 'GoogleNews-vectors-negative300.txt'
